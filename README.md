...
React is a library for javascript that makes it easier to build UI by taking advantage of its reusable components.
1. Describe component state.
The state of the component is an object of data that can be modified and accessed.
1. Describe props.
Props are arguments that are passed down to child components.
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects are anything that's changed outside of the function being executed. The second parameter in useEffect() is how you can sync up changes.
